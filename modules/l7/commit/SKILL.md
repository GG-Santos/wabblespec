...
**Step 1 — Infer scope.** If no scope is declared: infer from the primary directory or module of changed files (e.g., files in `modules/l6/copy/` → scope `copy`; files in `_shared/schemas/` → scope `schemas`).
