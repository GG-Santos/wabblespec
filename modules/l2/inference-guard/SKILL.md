...
Implements the Parseltongue algorithm (G0DM0D3 PAPER §3.4) adapted for SDLC-security vocabulary. Uses `_shared/scripts/inference-guard.py` for trigger detection and transform logic. The module shell calls the script; module does not reimplement.
