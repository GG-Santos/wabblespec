...
Condition: `_shared/dev/frameworks/web/core.md` or `_shared/dev/frameworks/web/security.md` are missing from the repository.
...
Condition: `_shared/dev/frameworks/web/nextjs.md` (or react/vue/svelte) missing when the detected signal matches.
