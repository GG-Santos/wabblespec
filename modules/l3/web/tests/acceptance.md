...
Then `_shared/dev/frameworks/web/nextjs.md` is loaded.
...
Then `_shared/dev/frameworks/web/core.md` and `_shared/dev/frameworks/web/security.md` are always loaded.
