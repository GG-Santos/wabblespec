...
Then `_shared/dev/frameworks/data/airflow.md` is loaded.
...
When platform-data-pipeline detects the pipeline type,
Then `_shared/dev/frameworks/data/dbt.md` is loaded.
...
When platform-data-pipeline detects the pipeline type,
Then `_shared/dev/frameworks/data/spark.md` is loaded.
