...
Condition: `_shared/dev/frameworks/mobile/core.md` missing.
...
Condition: `_shared/dev/frameworks/mobile/react-native.md` (or flutter/swift-uikit/kotlin-compose) absent when framework is detected.
