...
When platform-api-service detects the framework,
Then `_shared/dev/frameworks/api/grpc.md` is loaded.
...
When platform-api-service detects the framework,
Then `_shared/dev/frameworks/api/serverless.md` is loaded.
...
Then `_shared/dev/frameworks/api/core.md` and `_shared/dev/frameworks/api/security.md` are always loaded.
