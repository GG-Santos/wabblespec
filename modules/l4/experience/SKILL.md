...
## What this gateway adds beyond Design gateway
...
3. Load user-research.md
4. Load usability-testing.md
5. Load accessibility-deep-dive.md
6. Load satisfaction-measurement.md
7. Load research-ethics.md
8. Register audit-gates.md with Verifier
9. Write gateway activation receipt
```
