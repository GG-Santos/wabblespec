...
Run `scripts/graph-builder.py --check-freshness`. If graph is STALE (last build > 50 new drawers ago) or EXPIRED (never built): rebuild before querying. See freshness states in `_shared/references/staleness-states.md`.
