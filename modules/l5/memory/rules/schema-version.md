...
Both fields carry the same integer value. `schema_version` is the MemPalace field. `wabblespec_schema_version` is the WabbleSpec metadata field stored in ChromaDB.
