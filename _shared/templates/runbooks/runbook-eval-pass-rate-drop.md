...
*Generated from `_shared/templates/runbooks/runbook-eval-pass-rate-drop.md`. Replace all `___ UNDECLARED` with project-specific values before production use.*
