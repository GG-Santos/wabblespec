...
Usage:
    ...
    python _shared/scripts/archive.py \\
    ...
    python _shared/scripts/archive.py \\
        ...
        --files-delivered "_shared/references/foo.md"
    ...
    python _shared/scripts/archive.py ... --dry-run

    # Sweep mode — scan receipt-index for EXPIRED entries:
    python _shared/scripts/archive.py --sweep
