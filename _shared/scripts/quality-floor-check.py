...
declared in framework.yaml. Rules defined in _shared/references/quality-floor-gates.md.
...
Usage:
  ...
  python quality-floor-check.py --framework path/to/framework.yaml
"""
...
def main():
    ...
    parser.add_argument("--framework", default="framework.yaml",
