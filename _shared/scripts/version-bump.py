...
Usage:
    python _shared/scripts/version-bump.py --bump ADDITIVE
    python _shared/scripts/version-bump.py --bump BREAKING
    python _shared/scripts/version-bump.py --bump COSMETIC
    python _shared/scripts/version-bump.py --show          # print current version only
    python _shared/scripts/version-bump.py --set 1.2.3     # force a specific version
