...
def get_soundpack_dir() -> Path:
    ...
    Priority: WABBLE_SOUNDPACK_DIR env var -> _shared/sounds/ -> silent fail.
    """
    ...
    # Walk up from this script to find the repo root (_shared/sounds/)
    # Script lives at _shared/scripts/wabble-sound.py
    # -> parent = _shared/scripts/  -> parent = _shared/  -> parent = repo root
    script_dir   = Path(__file__).resolve().parent       # _shared/scripts/
