...
Usage:
    # Verifier receipt:
    python _shared/scripts/receipt-writer.py \\
        --type verifier \\
    ...
    python _shared/scripts/receipt-writer.py \\
        ...
        --files-written "_shared/references/foo.md" \\
    ...
    python _shared/scripts/receipt-writer.py --type verifier ... --out -

    # Validate a receipt against the base schema:
    python _shared/scripts/receipt-writer.py --validate path/to/receipt.json
