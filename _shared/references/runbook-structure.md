...
The alert slug must match the runbook filename exactly. Scaffold generates stub runbook files from `_shared/templates/runbooks/` at project creation time.
...
- `_shared/templates/runbooks/` — stub templates for common alert types
- `_shared/references/performance-budgets.md` — SLO tier definitions Monitor reads
