...
**Schema:** `_shared/schemas/error-event.schema.json`  
...
5. Register the routing action in the orchestration config at `_shared/references/orchestration.md` if not already handled by the type's default routing.
