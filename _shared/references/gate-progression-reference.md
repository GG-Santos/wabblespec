...
- `_shared/references/module-activation-matrix.md` — tabular view of which modules activate per workflow type
- `modules/l2/recipe/SKILL.md` — how Recipe reads task card to derive activation list
- `modules/l2/guard/SKILL.md` and `_shared/references/guard-policy-reference.md` — Guard's 5 layers
- `_shared/references/version-policy.md` — delta_class and SemVer bump rules referenced above
