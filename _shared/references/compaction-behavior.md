...
- Receipts and task cards are not affected by compaction — they live on disk (`_shared/references/`, `.wabblespec/receipts/`), not in the conversation context. A compacted session retains full receipt chain integrity.
