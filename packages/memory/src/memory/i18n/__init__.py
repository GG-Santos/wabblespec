"""i18n — Language dictionaries for WabbleSpec Memory.

Usage:
    from memory.i18n import load_lang, t
...
``memory.entity_detector``. See ``get_entity_patterns`` for the merge rules
