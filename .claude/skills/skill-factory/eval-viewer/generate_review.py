...
Usage:
    ...
    python generate_review.py <workspace-path> --previous-workspace /path/to/previous/workspace
...
def main() -> None:
    ...
    if args.static:
        ...
        source_assets = viewer_dir.parent / "assets"
        ...
        for asset_name in ("skill-factory-small.svg", "skill-factory.png"):
            shutil.copyfile(source_assets / asset_name, target_assets / asset_name)
