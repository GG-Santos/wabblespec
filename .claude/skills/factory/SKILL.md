...
Before writing any stub, Factory checks the proposed SKILL.md workflow sections against `_shared/references/prompt-patterns.md`. Any pattern violation found in the blueprint's workflow description blocks Factory from scaffolding until resolved.
