...
Uses `_shared/scripts/param-learner.py`. Feedback does not reimplement — it delegates to the script.
...
```bash
python _shared/scripts/param-learner.py --stats          # all context types
python _shared/scripts/param-learner.py --get <type>     # single profile JSON
python _shared/scripts/param-learner.py --reset <type>   # clear a profile
```
