...
| `.wabblespec/engine/shared/schemas/` | `<artifact>.schema.json` or `<artifact>.base.schema.json` |
| `.wabblespec/engine/shared/references/` | `<topic>.md` |
| `.wabblespec/engine/shared/infrastructure/` | `<topic>.md` |
