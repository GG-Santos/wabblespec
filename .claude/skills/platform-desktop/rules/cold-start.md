...
Condition: `.wabblespec/engine/shared/dev/frameworks/desktop/core.md` missing.
...
Condition: `.wabblespec/engine/shared/dev/frameworks/desktop/electron.md` or `desktop/tauri.md` absent when framework is detected.
