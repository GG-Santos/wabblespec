...
capability_handoff:
  always_load:
    - _shared/dev/frameworks/desktop/core.md
  conditional_load:
    - signal: "electron in package.json"
      load: _shared/dev/frameworks/desktop/electron.md
    - signal: "src-tauri/tauri.conf.json"
      load: _shared/dev/frameworks/desktop/tauri.md
  gateway_references:
...
**Platform activation receipt** (`.wabblespec/receipts/platform-desktop-{timestamp}.json`)
