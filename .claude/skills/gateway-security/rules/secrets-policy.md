...
**Structured logging:** If using JSON logging (required by `_shared/dev/infrastructure/observability.md`), ensure the JSON serializer does not log masked fields by accident. Use field-level exclusion, not post-hoc string replacement.
