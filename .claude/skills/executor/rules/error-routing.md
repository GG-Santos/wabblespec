...
Per-wave reference for Executor. Maps error type to routing action. Full type definitions: `_shared/references/error-taxonomy.md`.
...
When emitting an error, include all fields required by `_shared/schemas/error-event.schema.json`:
