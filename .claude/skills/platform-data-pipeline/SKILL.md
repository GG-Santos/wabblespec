...
capability_handoff:
  always_load:
    - _shared/dev/frameworks/data/core.md
  conditional_load:
    - signal: "Airflow DAGs or Prefect flows"
      load: _shared/dev/frameworks/data/airflow.md
    - signal: "dbt models"
      load: _shared/dev/frameworks/data/dbt.md
    - signal: "Spark jobs"
      load: _shared/dev/frameworks/data/spark.md
  gateway_references:
