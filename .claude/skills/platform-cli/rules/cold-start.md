...
Condition: `_shared/dev/frameworks/cli/core.md` missing from the repository.
...
Condition: `_shared/dev/frameworks/cli/cobra.md` (or click/clap) missing when the framework is detected.
