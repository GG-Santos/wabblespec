...
| Receipts | `.wabblespec/state/receipts/**` | Immutable after write — I10 |
| Memory drawers | `.wabblespec/state/memory/wings/**` | Memory module owns drawer content |
| Plans | `.wabblespec/state/plans/**` | Plans are operational artifacts — not delivery prose |

## What Polish CAN touch

- SKILL.md files (prose documentation)
- Task spec cards (`.wabblespec/state/plans/task-card.md`)
