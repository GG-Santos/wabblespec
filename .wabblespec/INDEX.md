...
100 modules registered in `framework.yaml`. See `framework.yaml` for canonical registry — this file tracks session-level state only.
<!-- end auto-updated -->
...
<!-- auto-updated: index-update.py -->
Completed tasks: `.wabblespec/archive/receipt-index.json` (43 entries).

Seed pipeline receipts: `.wabblespec/receipts/` — 175 individual receipts accumulated.
<!-- end auto-updated -->
...
<!-- auto-updated: index-update.py -->
Quality floor status: see `quality-floor-check.py` output. (100 modules registered)
<!-- end auto-updated -->

## Witness

<!-- auto-updated: index-update.py -->
Module file integrity witness recorded at `.wabblespec/archive/witness.json` (97 modules, 2026-05-25). Re-record after any intentional module file change with `python _shared/scripts/validate-graph.py --record-witness`. Check drift with `--check-hashes`.
<!-- end auto-updated -->
