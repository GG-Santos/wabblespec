...
Gateway sequencing and routing protocol: `.wabblespec/engine/shared/infrastructure/gateway-pattern.md`
...
python .wabblespec/engine/shared/scripts/quality-floor-check.py --framework framework.yaml

# Framework graph validation: A7 rule — no script paths in consumers
python .wabblespec/engine/shared/scripts/validate-graph.py --framework framework.yaml
