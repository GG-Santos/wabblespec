...
Guard (L2) is the runtime enforcement layer. It reads `.wabblespec/engine/shared/infrastructure/guard-policy.md` at cold-start and enforces risk tiers across all module operations.
...
- Modifying `.wabblespec/engine/shared/` files
