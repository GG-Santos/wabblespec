...
| Module | Role |
|--------|------|
| `guard` | Runtime policy enforcement. Applies risk tiers to all operations. Reads `.wabblespec/engine/shared/infrastructure/guard-policy.md`. Five nested scope boundaries. |
| `economy` | Token economy enforcement. Monitors output density against `.wabblespec/engine/shared/infrastructure/economy-principles.md`. |
