"""
knowledge_graph.py — Temporal Entity-Relationship Graph for WabbleSpec Memory
=====================================================================
...
def _default_kg_path() -> str:
    ...
    if memory_root:
        return os.path.join(memory_root, "knowledge_graph.sqlite3")
    return os.path.expanduser("~/.wabblespec_memory/knowledge_graph.sqlite3")
