...
Usage:
    from memory.spellcheck import spellcheck_user_text
...
# CamelCase: ChromaDB, WabbleSpec Memory, LongMemEval
...
if __name__ == "__main__":
    test_cases = [
        ...
        "WabbleSpecMemory cant be fine-tunned if you alredy kno the question",
    ...
    for msg in test_cases:
        result = spellcheck_user_text(msg, known_names={"riley", "sam", "wabblespec_memory"})
