...
from memory.llm_client import LLMError, LLMProvider
...
SYSTEM_PROMPT = """You are helping organize a user's memory store by classifying capitalized tokens found in their files.
...
def collect_corpus_text(
    ...
    from memory.entity_detector import PROSE_EXTENSIONS, SKIP_DIRS
