#!/usr/bin/env python3
"""
layers.py — 4-Layer Memory Stack for wabblespec_memory
===================================================
...
Reads directly from ChromaDB (wabblespec_drawers)
and ~/.wabblespec_memory/identity.txt.
"""
...
class Layer0:
    ...
    Reads from ~/.wabblespec_memory/identity.txt — a plain-text file the user writes.
    ...
    def __init__(self, identity_path: str = None):
        if identity_path is None:
            identity_path = os.path.expanduser("~/.wabblespec_memory/identity.txt")
    ...
    def render(self) -> str:
        ...
        if os.path.exists(self.path):
            ...
            self._text = (
                "## L0 — IDENTITY\nNo identity configured. Create ~/.wabblespec_memory/identity.txt"
            )
...
class Layer1:
    ...
    def generate(self) -> str:
        ...
        try:
            ...
            return "## L1 — No palace found. Run: memory mine <dir>"
...
class Layer3:
    ...
    Reuses searcher.py logic against wabblespec_drawers.
    """
...
class MemoryStack:
    ...
    def __init__(self, palace_path: str = None, identity_path: str = None):
        cfg = WabbleSpecMemoryConfig()
        self.palace_path = palace_path or cfg.palace_path
        self.identity_path = identity_path or os.path.expanduser("~/.wabblespec_memory/identity.txt")
