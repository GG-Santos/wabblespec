...
Usage:
    ...
    python .wabblespec/engine/shared/scripts/provenance-append.py contradiction \\
        --drawer-id arch-layer-overview-20260526 \\
    ...
    python .wabblespec/engine/shared/scripts/provenance-append.py transition \\
        --drawer-id arch-layer-overview-20260526 \\
        --from-state FRESH \\
        --to-state AGING \\
    ...
    # Record a deletion:
    python .wabblespec/engine/shared/scripts/provenance-append.py delete \\
    ...
    python .wabblespec/engine/shared/scripts/provenance-append.py show \\
        --drawer-id arch-layer-overview-20260526
