...
Usage (standalone):
  python .wabblespec/engine/shared/scripts/markdown-extract.py --check <original> <transformed>
  python .wabblespec/engine/shared/scripts/markdown-extract.py --check <original> <transformed> --json
