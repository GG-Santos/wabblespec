...
Replaces Claude reading .wabblespec/engine/shared/references/command-risk-policy.md (~2,225 tokens) on every
...
Policy rules embedded from .wabblespec/engine/shared/references/command-risk-policy.md:
