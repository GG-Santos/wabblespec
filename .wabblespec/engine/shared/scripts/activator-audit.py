...
Usage:
  python .wabblespec/engine/shared/scripts/activator-audit.py
  python .wabblespec/engine/shared/scripts/activator-audit.py --module modules/l2/guard/SKILL.md
  python .wabblespec/engine/shared/scripts/activator-audit.py --fix     # auto-removes ✅/❌ only
  python .wabblespec/engine/shared/scripts/activator-audit.py --verbose # show all files checked
  python .wabblespec/engine/shared/scripts/activator-audit.py --json    # machine-readable output
  python .wabblespec/engine/shared/scripts/activator-audit.py --strict  # also check non-routing sections
"""
