...
Usage:
    ...
    python .wabblespec/engine/shared/scripts/receipt-chain-validate.py --session-id seed-run-20260526xx

    # Check specific required types (override defaults):
    python .wabblespec/engine/shared/scripts/receipt-chain-validate.py \\
    ...
    python .wabblespec/engine/shared/scripts/receipt-chain-validate.py --all

    # List receipts for a session without validating:
    python .wabblespec/engine/shared/scripts/receipt-chain-validate.py --session-id xxx --list
