...
Usage:
    ...
    python .wabblespec/engine/shared/scripts/framework-register.py register \\
        --id my-module \\
        --layer L5 \\
    ...
    python .wabblespec/engine/shared/scripts/framework-register.py set \\
        --id my-module \\
    ...
    python .wabblespec/engine/shared/scripts/framework-register.py touch-validated \\
        --ids recipe specify decompose guard \\
        --date 2026-05-26

    # Show one module entry as JSON:
    python .wabblespec/engine/shared/scripts/framework-register.py show --id my-module

    # List all module IDs (with optional layer filter):
    python .wabblespec/engine/shared/scripts/framework-register.py list --layer L5

    # Add a consumer to a shared artifact:
    python .wabblespec/engine/shared/scripts/framework-register.py add-consumer \\
        --path .wabblespec/engine/shared/schemas/receipt.base.schema.json \\
        --consumer my-module
...
def find_framework(start_dir=None):
    ...
    candidate = start_dir
    for _ in range(10):
        path = os.path.join(candidate, ".wabblespec/wabblespec.yaml")
