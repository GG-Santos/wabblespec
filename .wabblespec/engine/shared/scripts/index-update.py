...
Usage:
    ...
    python .wabblespec/engine/shared/scripts/index-update.py

    # Update only specific sections:
    python .wabblespec/engine/shared/scripts/index-update.py --sections modules quality receipts witness version

    # Dry run — show what would be written:
    python .wabblespec/engine/shared/scripts/index-update.py --dry-run

    # JSON summary only:
    python .wabblespec/engine/shared/scripts/index-update.py --json
...
def build_quality_content(ws):
    ...
    return (
        ...
        f"(run `python .wabblespec/engine/shared/scripts/quality-floor-check.py` for detail)."
    ), True
