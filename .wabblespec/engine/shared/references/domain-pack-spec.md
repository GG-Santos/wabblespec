...
- Override shared schemas or references under `.wabblespec/engine/shared/`
...
- Reference shared schemas under `.wabblespec/engine/shared/schemas/` as read-only
- Reference shared references under `.wabblespec/engine/shared/references/` as read-only
