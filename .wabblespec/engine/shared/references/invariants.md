...
| I11 | FRAMEWORK AND PRODUCT NEVER MIX | .wabblespec/ = framework space. project/repo/ = product space. No crossing. Each output has exactly one owning module. Authority conflicts resolved before execution. | Framework file in product space (or reverse) = I11 violation |
