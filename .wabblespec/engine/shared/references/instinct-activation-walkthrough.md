...
After validating at least 3 patterns, update `.wabblespec/engine/shared/references/l8-corpus-gate.md`:
...
- After gate met: Synth may propose changes to `.wabblespec/engine/shared/`, module SKILL.md files, and `framework.yaml`
