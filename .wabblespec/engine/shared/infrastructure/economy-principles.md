...
Framework-level token economy rules. Every module reads these to govern its output density. Invariant I12 in `.wabblespec/engine/shared/references/invariants.md` is the enforcement hook; these principles are the specification I12 enforces.
