...
Condition: `.wabblespec/engine/shared/scripts/wabble-health.py` (or `modules/l7/monitor/rules/wabble-health.md`) missing.
...
Action: BLOCK ongoing monitoring. Surface: "No observability signals available. Configure structured logging (minimum) before Monitor can operate. See `.wabblespec/engine/shared/dev/infrastructure/observability.md`."
