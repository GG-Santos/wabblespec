...
- `.wabblespec/engine/shared/schemas/receipt.base.schema.json`
- `.wabblespec/engine/shared/schemas/skill-rules.schema.json`
- `.wabblespec/engine/shared/schemas/error-event.schema.json`
- `.wabblespec/engine/shared/schemas/drawer.schema.json`
