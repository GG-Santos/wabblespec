...
Generates test stubs and test strategy from spec acceptance criteria. Every EARS requirement in a P4 spec maps to at least one test case. Untestable requirements are flagged, not silently skipped. Does not execute tests — produces stubs and test plan that Verifier's Test mode uses.
