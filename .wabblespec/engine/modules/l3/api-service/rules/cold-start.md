...
Condition: `.wabblespec/engine/shared/dev/frameworks/api/core.md` or `.wabblespec/engine/shared/dev/frameworks/api/security.md` missing.
...
Condition: `.wabblespec/engine/shared/dev/frameworks/api/grpc.md` or `api/graphql.md` absent when proto files or GraphQL schema detected.
