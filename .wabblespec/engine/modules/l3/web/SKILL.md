...
4. Load matched language module from .wabblespec/engine/shared/dev/languages/node/
...
capability_handoff:
  always_load:
    - .wabblespec/engine/shared/dev/frameworks/web/core.md
    - .wabblespec/engine/shared/dev/frameworks/web/security.md
