...
Condition: `.wabblespec/engine/shared/dev/frameworks/game/core.md` missing.
...
Condition: `.wabblespec/engine/shared/dev/frameworks/game/unity.md` (or unreal/godot) absent when engine is detected.
