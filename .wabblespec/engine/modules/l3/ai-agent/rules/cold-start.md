...
Condition: `.wabblespec/engine/shared/dev/frameworks/ai/core.md` or `.wabblespec/engine/shared/dev/frameworks/ai/safety.md` missing.
...
Condition: `.wabblespec/engine/shared/dev/frameworks/ai/langchain.md` or `ai/openai-sdk.md` absent when framework is detected.
