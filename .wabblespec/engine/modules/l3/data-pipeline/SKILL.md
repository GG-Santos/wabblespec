...
capability_handoff:
  always_load:
    - .wabblespec/engine/shared/dev/frameworks/data/core.md
  conditional_load:
    - signal: "Airflow DAGs or Prefect flows"
      load: .wabblespec/engine/shared/dev/frameworks/data/airflow.md
    - signal: "dbt models"
      load: .wabblespec/engine/shared/dev/frameworks/data/dbt.md
    - signal: "Spark jobs"
      load: .wabblespec/engine/shared/dev/frameworks/data/spark.md
  gateway_references:
