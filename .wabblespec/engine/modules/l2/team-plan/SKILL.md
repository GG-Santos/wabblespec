...
Multi-agent coordination for L4 complexity tasks. Decomposes work into specialist roles, manages handoffs, maintains shared receipt chain across agents. Activates only when Recipe declares L4 complexity AND single-agent execution has been validated for the task class first.
