...
**Provenance** maintains a cascade — every artifact can be traced to its source receipt and the module that produced it. The provenance cascade test (`_shared/scripts/` — historical) verified the chain holds across all registered receipts.
